...
function requireSingleDefinition(
  ...
  console.warn(`[AutoShopSearchWidget] Missing single filter definition: ${id}`)
  return fallback
}
...
function requireRangeDefinition(
  ...
  console.warn(`[AutoShopSearchWidget] Missing range filter definition: ${id}`)
  return fallback
}
...
function requireMultiDefinition(
  ...
  console.warn(`[AutoShopSearchWidget] Missing multi filter definition: ${id}`)
  return fallback
}
